...
function App() {
  return (
    <div className="App">
      <h1 className="Name">Benito Tridella Dolce 🇦🇷</h1>
      <p className="Subtitle">Desarrollador Frontend 💻</p>
      <div className='container-main'>
        <p className='description'>
          🚀 Mi enfoque está en crear interfaces modernas , responsive 📱 y eficientes, aprovechando mis conocimientos y mejores prácticas 
          en el desarrollo web. Y sin dejar de lado la performance ⚡ y la escalabilidad 📈.
        </p>
